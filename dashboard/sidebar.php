...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-dark-800 border-r border-gray-200 dark:border-white/5 pt-16 transform -translate-x-full lg:translate-x-0 transition-transform duration-300">
    <div class="h-full overflow-y-auto p-4 space-y-1">
        ...
        <a href="app.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('app') ?>"><i class="fa-solid fa-chart-pie w-5 text-center"></i> Dashboard</a>
        <a href="profile.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('profile') ?>"><i class="fa-solid fa-user-circle w-5 text-center"></i> My Profile</a>
        <div class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 mt-6 px-3">Management</div>
        <a href="accounts.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('accounts') ?> <?= active('accountdetail') ?>"><i class="fa-solid fa-users w-5 text-center"></i> Accounts</a>
        <a href="sellers.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('sellers') ?>"><i class="fa-solid fa-store w-5 text-center"></i> Sellers</a>
        <a href="products.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('products') ?>"><i class="fa-solid fa-box w-5 text-center"></i> Products</a>
        <a href="orders.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('orders') ?>"><i class="fa-solid fa-receipt w-5 text-center"></i> Orders</a>
        <div class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 mt-6 px-3">Features</div>
        <a href="auctions.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('auctions') ?>"><i class="fa-solid fa-gavel w-5 text-center"></i> Auctions</a>
        <a href="lotteries.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('lotteries') ?>"><i class="fa-solid fa-ticket w-5 text-center"></i> Lotteries</a>
        <a href="mystery-boxes.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors <?= active('mystery-boxes') ?>"><i class="fa-solid fa-cube w-5 text-center"></i> Mystery Boxes</a>
