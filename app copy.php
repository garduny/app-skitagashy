...
<main class="relative z-10 pt-16 lg:pl-64 min-h-screen">
    ...
    <div class="relative z-10 max-w-[1800px] mx-auto px-4 pb-14">
        <section class="slide-up text-center py-10">
            ...
            <p class="font-body text-base font-medium text-slate-500 dark:text-slate-400 max-w-xl mx-auto leading-relaxed mb-8">
            ...
            <div class="flex flex-wrap gap-3 justify-center">
                <a href="https://jup.ag/swap/SOL-GASHY" target="_blank"
                    class="inline-flex items-center gap-2 px-6 py-3 bg-[#00ffaa] text-black font-display font-bold text-sm tracking-wide rounded-lg hover:bg-[#00ffcc] hover:shadow-[0_4px_24px_rgba(0,255,170,.35)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <a href="https://www.coingecko.com/en/coins/gashy" target="_blank"
                    class="inline-flex items-center gap-2 px-6 py-3 bg-[#8DC351] text-white font-display font-bold text-sm tracking-wide rounded-lg hover:bg-[#7caf43] hover:-translate-y-0.5 transition-all duration-200">
                    🦎 COINGECKO
                </a>
                <button onclick="navigator.clipboard.writeText('DokPYQ33k3T9S7EEesvwvuuAtoQb4pY8NWszukKwXWjv');notyf.success('Contract Copied!')"
                    class="inline-flex items-center gap-2 px-6 py-3 bg-transparent text-[#00ffaa] border border-[rgba(0,255,170,.5)] font-display font-bold text-sm tracking-wide rounded-lg hover:bg-[rgba(0,255,170,.08)] hover:-translate-y-0.5 transition-all duration-200">
        ...
        <div class="slide-up stat-grid-wrap grid grid-cols-2 md:grid-cols-4 gap-px bg-[rgba(0,255,170,.1)] border border-[rgba(0,255,170,.1)] rounded-xl overflow-hidden mb-12">
            <?php
            $stats = [
        ...
        <div class="slide-up panel-bg bg-[rgba(8,13,26,.85)] border border-[rgba(0,255,170,.12)] rounded-xl p-5 mb-12 hover:border-[rgba(0,255,170,.25)] hover:shadow-[0_8px_32px_rgba(0,255,170,.05)] transition-all duration-300">
            <div class="flex items-center gap-3 mb-5">
                ...
                <span class="ml-auto font-body text-[.6rem] text-slate-600 tracking-widest">SOLANA</span>
            </div>
        ...
        <div class="slide-up grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-4 mb-12">
                        ...
                        <div class="banner-slide absolute inset-0 transition-opacity duration-700" data-index="<?= $bi ?>" style="opacity:<?= $bi === 0 ? '1' : '0' ?>;z-index:<?= $bi === 0 ? 2 : 1 ?>">
                            ...
                            <div class="absolute bottom-0 left-0 p-6 z-10">
                                ...
                                <a href="<?= htmlspecialchars($b['link_url']) ?>"
                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#00ffaa] text-black font-display font-bold text-sm rounded-lg hover:bg-[#00ffcc] transition-colors">
                                    EXPLORE NOW
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
            ...
            <div class="flex flex-col gap-4">
                <a href="mystery-boxes.php<?= $mystery_box ? '?id=' . $mystery_box['id'] : '' ?>"
                    class="flex-1 rounded-xl p-5 flex flex-col justify-between min-h-[160px] relative overflow-hidden hover:-translate-y-1 transition-transform duration-300 no-underline text-white"
                    ...
                    <div>
                        ...
                        <?php if ($mystery_box): ?>
                            <div class="font-body text-[.6rem] text-white/50 mt-0.5"><?= number_format($mystery_box['price_gashy']) ?> G / OPEN</div>
                        <?php endif; ?>
                    </div>
                ...
                <a href="lottery.php"
                    ...
                    <div>
                        ...
                        <?php if (!empty($lottery['draw_time'])): ?>
                            <div class="font-body text-[.6rem] text-white/50 mt-0.5">DRAW: <?= date('d M H:i', strtotime($lottery['draw_time'])) ?></div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="slide-up mb-12">
            <div class="text-center mb-8">
                ...
                <p class="sec-sub font-body text-slate-500 dark:text-slate-400 text-sm">More than just a meme — real utility, transparency, and community.</p>
            </div>
        ...
        <div class="slide-up mb-12">
            <div class="flex items-center justify-between flex-wrap gap-3 mb-6">
                ...
                <div class="hidden flex items-center gap-2 px-3 py-1.5 bg-red-500/10 border border-red-500/30 rounded-lg font-body text-xs font-bold text-red-400">
                ...
                foreach ($flash_deals as $p): $img = json_decode($p['images'])[0] ?? 'assets/placeholder.png';
                    ...
                    <a href="product.php?slug=<?= htmlspecialchars($p['slug']) ?>" class="prod-card panel-bg bg-[rgba(8,13,26,.85)] border border-[rgba(0,255,170,.12)] rounded-xl overflow-hidden hover:border-[rgba(0,255,170,.3)] hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(0,255,170,.08)] transition-all duration-300 no-underline block">
                        <div class="aspect-square overflow-hidden relative prod-thumb-bg bg-[#0c1120]">
                            ...
                            <span class="absolute top-2 right-2 px-2 py-0.5 bg-red-600 text-white font-body font-bold text-[.55rem] tracking-wide rounded">-20%</span>
                        </div>
                        <div class="p-3.5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6 mb-12">
            <div class="slide-up">
                <h2 class="sec-title font-display font-black text-slate-900 dark:text-white mb-5" style="font-size:clamp(1.3rem,3.5vw,1.8rem)">NEW ARRIVALS</h2>
            ...
            <div class="slide-up">
                <h2 class="sec-title font-display font-black text-slate-900 dark:text-white mb-5" style="font-size:clamp(1.3rem,3.5vw,1.8rem)">TOP SELLERS</h2>
                <div class="panel-bg bg-[rgba(8,13,26,.85)] border border-[rgba(0,255,170,.12)] rounded-xl p-4">
                    ...
                    foreach ($top_sellers as $i => $s): ?>
                        <div class="seller-divider flex items-center gap-3 py-3 border-b border-black/[.06] dark:border-white/[.04] last:border-0">
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center font-display font-black text-sm flex-shrink-0"
                            ...
                            <div class="seller-sales font-body text-[10px] font-bold text-slate-400 dark:text-slate-500 flex-shrink-0"><?= htmlspecialchars($s['total_sales']) ?> SOLD</div>
                        </div>
                    <?php endforeach; ?>
                </div>
                <div class="mt-4 rounded-xl p-5 text-center" style="background:linear-gradient(135deg,#1e40af,#7c3aed)">
                    ...
                    <div class="font-body text-xs text-white/70 mb-4">Launch your own crypto store today</div>
                    <a href="seller.php"
                        class="flex items-center justify-center gap-2 w-full py-3 bg-[#00ffaa] text-black font-display font-bold text-sm rounded-lg hover:bg-[#00ffcc] hover:shadow-[0_4px_20px_rgba(0,255,170,.3)] transition-all duration-200">
                        APPLY NOW
                    </a>
                </div>
            </div>
