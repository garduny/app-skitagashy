...
$products = getQuery(" SELECT p.id,p.title,p.description,p.price_gashy,p.stock,p.type,p.status,p.images,c.name cat_name FROM products p LEFT JOIN categories c ON p.category_id=c.id WHERE p.seller_id=$uid ORDER BY p.id DESC ");
