...
try {
    execute(" INSERT INTO orders (user_id,total_gashy,tx_signature,status,created_at) VALUES ($uid,$total,'$txSig','pending',NOW()) ");
    ...
    execute(" INSERT INTO transactions (user_id,type,amount,tx_signature,status) VALUES ($uid,'purchase',$total,'$txSig','pending') ");
    execute(" COMMIT ");
