...
$expired = getQuery(" SELECT id,product_id FROM gift_cards WHERE is_sold=0 AND expiry_date IS NOT NULL AND expiry_date<CURDATE() ");
if (!empty($expired)) {
...
} else echo "No expired gift cards found.\n";
