...
function renderTable() {
    ...
    list.innerHTML = myProducts.map(p => {
        ...
        const gashy = parseFloat(p.price_gashy || 0);
        return `<tr>
<td>
...
<span class="mono" style="font-size:.8rem;font-weight:700">$${usd.toFixed(2)}</span>
<span class="mono" style="font-size:.7rem;color:var(--muted)">${gashy.toFixed(2)} G</span>
</div>
</td>
...
async function saveProduct() {
    ...
    } catch (e) { console.log(e); notyf.error('Save failed'); }
}
