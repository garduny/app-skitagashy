                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    <div class="relative">
                        ...
                        <div class="absolute bottom-0 right-0 w-8 h-8 bg-white dark:bg-[#151A23] rounded-full flex items-center justify-center border border-gray-200 dark:border-white/10 shadow-sm" title="Tier">
                            <span id="account-tier-icon">🥉</span>
                        </div>
                    </div>
                    <div class="text-center md:text-left flex-1">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-1">Welcome back, <span id="profile-accountname">Account</span></h1>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-[#151A23] rounded-2xl p-6 border border-gray-200 dark:border-white/5 space-y-4 shadow-sm dark:shadow-none">
                        <div>
                            ...
                            <input type="text" id="input-accountname" class="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2 text-gray-900 dark:text-white focus:border-blue-500 outline-none transition-colors">
                        </div>
                        <div>
