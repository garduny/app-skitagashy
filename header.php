    ...
    <header class="fixed top-0 w-full z-50 glass h-16 transition-all duration-300">
        <div class="flex items-center justify-between h-full px-4 lg:px-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div id="user-info" class="hidden md:flex flex-col items-end mr-2 opacity-0 transition-opacity duration-300">
                    <span class="text-[10px] text-gray-400 font-medium uppercase tracking-wider">Balance</span>
                    <span class="text-sm font-bold text-green-400 font-mono" id="user-balance">0.00 SOL</span>
                </div>
