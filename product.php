...
if(!$slug){echo"<script>location='market.php'</script>";exit;}
...
?>
<style>
@keyframes luxuryGlow{0%{background-position:0% 50%}100%{background-position:200% 50%}}
@keyframes softPulse{0%,100%{opacity:1;transform:translateY(0)}50%{opacity:.72;transform:translateY(-2px)}}
@keyframes cardFloat{0%,100%{transform:translateY(0)}50%{transform:translateY(-4px)}}
.product-page-bg{position:relative}
.product-page-bg:before{content:'';position:absolute;top:6%;right:6%;width:480px;height:480px;border-radius:9999px;background:rgba(59,130,246,.08);filter:blur(120px);pointer-events:none}
.product-page-bg:after{content:'';position:absolute;bottom:6%;left:4%;width:460px;height:460px;border-radius:9999px;background:rgba(139,92,246,.08);filter:blur(120px);pointer-events:none}
.lux-card{background:linear-gradient(135deg,rgba(15,23,42,.82),rgba(17,24,39,.92));backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,.06);box-shadow:0 18px 60px rgba(2,6,23,.28)}
.lux-line{position:relative;overflow:hidden}
.lux-line:before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,#00ffaa,#3b82f6,#8b5cf6,#00ffaa);background-size:200% 100%;animation:luxuryGlow 4s linear infinite}
.hero-img{position:relative;overflow:hidden;background:linear-gradient(135deg,rgba(15,23,42,.78),rgba(30,41,59,.82))}
.hero-img img{transition:transform .8s cubic-bezier(.22,1,.36,1)}
.hero-img:hover img{transform:scale(1.06)}
.hero-img:after{content:'';position:absolute;inset:0;background:linear-gradient(to top,rgba(2,6,23,.34),transparent 40%,transparent);pointer-events:none}
.thumb{border:2px solid rgba(255,255,255,.08);transition:all .28s ease;background:rgba(255,255,255,.03)}
.thumb:hover,.thumb.active{border-color:#00ffaa;box-shadow:0 0 20px rgba(0,255,170,.22);transform:translateY(-2px)}
.seller-card{background:linear-gradient(135deg,rgba(15,23,42,.72),rgba(30,41,59,.78));border:1px solid rgba(255,255,255,.06);backdrop-filter:blur(12px);transition:all .28s ease}
.seller-card:hover{border-color:rgba(0,255,170,.22);box-shadow:0 12px 40px rgba(0,255,170,.08)}
.metric-card{background:linear-gradient(135deg,rgba(255,255,255,.05),rgba(255,255,255,.02));border:1px solid rgba(255,255,255,.06)}
.desc-card{background:linear-gradient(135deg,rgba(15,23,42,.74),rgba(17,24,39,.88));border:1px solid rgba(255,255,255,.06)}
.price-card{background:linear-gradient(135deg,rgba(15,23,42,.95),rgba(17,24,39,.95));backdrop-filter:blur(18px);border:1px solid rgba(59,130,246,.16);position:relative;overflow:hidden;box-shadow:0 22px 70px rgba(2,6,23,.34)}
.price-card:before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,#3b82f6,#8b5cf6,#00ffaa,#3b82f6);background-size:220% 100%;animation:luxuryGlow 4s linear infinite}
.price-chip{background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08)}
.stock-badge{animation:softPulse 1.7s ease-in-out infinite}
.attr-box{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08)}
.attr-select{appearance:none;background:rgba(2,6,23,.44);border:2px solid rgba(255,255,255,.08);transition:all .28s ease}
.attr-select:focus{outline:none;border-color:rgba(0,255,170,.44);box-shadow:0 0 0 4px rgba(0,255,170,.08)}
.qty-input{background:rgba(2,6,23,.44);border:2px solid rgba(255,255,255,.08);transition:all .28s ease}
.qty-input:focus{outline:none;border-color:rgba(59,130,246,.46);box-shadow:0 0 0 4px rgba(59,130,246,.08)}
.buybtn{background:linear-gradient(135deg,#00ffaa,#3b82f6);color:#000;box-shadow:0 12px 30px rgba(0,255,170,.22);transition:all .28s ease;position:relative;overflow:hidden}
.buybtn:before{content:'';position:absolute;inset:0;background:linear-gradient(90deg,transparent,rgba(255,255,255,.22),transparent);transform:translateX(-100%);transition:transform .7s ease}
.buybtn:hover:not(:disabled):before{transform:translateX(100%)}
.buybtn:hover:not(:disabled){transform:translateY(-2px);box-shadow:0 18px 40px rgba(0,255,170,.3)}
.sharebtn{background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);transition:all .28s ease}
.sharebtn:hover{background:rgba(255,255,255,.09);transform:translateY(-2px)}
.trust-pill{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.06)}
.related-card{background:linear-gradient(135deg,rgba(15,23,42,.82),rgba(17,24,39,.9));backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,.06);transition:all .3s ease}
.related-card:hover{transform:translateY(-4px);border-color:rgba(0,255,170,.22);box-shadow:0 18px 50px rgba(0,255,170,.08)}
.related-card img{transition:transform .7s cubic-bezier(.22,1,.36,1)}
.related-card:hover img{transform:scale(1.06)}
.light-title{background:linear-gradient(135deg,#111827,#1d4ed8,#111827);-webkit-background-clip:text;background-clip:text;color:transparent}
html.dark .light-title{background:linear-gradient(135deg,#fff,#bfdbfe,#fff);-webkit-background-clip:text;background-clip:text;color:transparent}
html:not(.dark) .product-page-bg:before{background:rgba(0,163,114,.08)}
html:not(.dark) .product-page-bg:after{background:rgba(59,130,246,.08)}
html:not(.dark) .lux-card,html:not(.dark) .seller-card,html:not(.dark) .desc-card,html:not(.dark) .price-card,html:not(.dark) .related-card{background:linear-gradient(135deg,rgba(255,255,255,.96),rgba(248,250,252,.96));border:1px solid rgba(0,0,0,.08);box-shadow:0 18px 50px rgba(15,23,42,.08)}
html:not(.dark) .hero-img{background:linear-gradient(135deg,rgba(255,255,255,.96),rgba(241,245,249,.96))}
html:not(.dark) .hero-img:after{background:linear-gradient(to top,rgba(241,245,249,.18),transparent 40%,transparent)}
html:not(.dark) .thumb{border-color:rgba(0,0,0,.08);background:rgba(255,255,255,.9)}
html:not(.dark) .metric-card,html:not(.dark) .price-chip,html:not(.dark) .attr-box,html:not(.dark) .trust-pill,html:not(.dark) .sharebtn{background:rgba(255,255,255,.8);border-color:rgba(0,0,0,.08)}
html:not(.dark) .attr-select,html:not(.dark) .qty-input{background:#fff;border-color:rgba(0,0,0,.12);color:#0f172a}
</style>
